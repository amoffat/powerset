...
skip potentially quadrillions (not a typo, see the n-queens output!) of nodes.
...
actually examine is only 234,271, while the number of nodes we skip is 1,125,899,906,608,352.
...
// for a given board state, use its optimization fields to determine if a candidate position is valid or not
